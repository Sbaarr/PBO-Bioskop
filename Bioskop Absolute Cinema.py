...
class CinemaApp:
    ...
    def delete_film(self, film):
        try:
            ...
            confirm_dialog = ft.AlertDialog(
                ...
                actions=[
                    ft.TextButton("Ya", on_click=lambda e: self.confirm_delete_film(film)),
    ...
    def confirm_delete_film(self, film):
        try:
            ...
            self.list_film.films = [f for f in self.list_film.films if f.get_judul() != film.get_judul()]
            self.list_film.simpan_ke_file()
            ...
            self.show_snackbar(f"Terjadi kesalahan saat menghapus: {str(ex)}")
